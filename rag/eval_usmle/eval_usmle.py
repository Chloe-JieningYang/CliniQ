...
from retriever import load_rag_retriever, rag_retrieval
    ...
    for step_idx in [1,2,3]: 
        ...
        for i, question in enumerate(pbar): 
            ...
            for j in range(ntries): 
                context = rag_retrieval(rag_retriever, question["question"], k=1)
                response = model(
                    instruction="Answer this multiple choice question strictly based on the following retrieved context. If the retrieved context does not contain the answer, say you don't know. Always use the following format for your answer: 'A: ...', 'B: ...', 'C: ...' or 'D: ...'. Do not include any other text in your answer.\n\nContext:\n" + context, 
